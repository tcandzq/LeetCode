...
* - [1669.合并两个链表.py](LinkedList/MergeInBetweenLinkedLists.py)
...
* - [1574.删除最短的子数组使剩余数组有序.py](BinarySearch/ShortestSubarrayToBeRemovedToMakeArraySorted.py)
...
* - [5.最长回文子串.py](DynamicProgramming/LongestPalindromicSubstring.py)
...
* - [221.最大正方形.py](DynamicProgramming/MaximalSquare.py)
* - [1139.最大的以1为边界的正方形.py](DynamicProgramming/Largest1BorderedSquare.py)
...
* - [691.贴纸拼词.py](DynamicProgramming/StickersToSpellWord.py)
...
* - [K个逆序对数组.py](DynamicProgramming/KInversePairsArray.py)
...
* - [石子游戏.py](DynamicProgramming/StoneGame.py)
* - [646.最长数对链.py](DynamicProgramming/MaximumLengthOfPairChain.py)
* - [1000.合并石头的最低成本.py](DynamicProgramming/MinimumCostToMergeStones.py)
* - [691.贴纸拼词.py](DynamicProgramming/MinimumCostToMergeStones.py)
...
* - [611.有效三角形的个数.py](TwoPointer/ValidTriangleNumber.py)
* - [524.通过删除字母匹配到字典里最长单词](TwoPointer/LongestWordInDictionaryThroughDeleting.py)
* - [1498.满足条件的子序列数目](TwoPointer/NumberOfSubsequencesThatSatisfyTheGivenSumCondition.py)
* - [905.按奇偶排序数组](TwoPointer/SortArrayByParity.py)
## [数组(及其相关结构)](Array/)
...
* - [最大连续1的个数.py](Array/MaxConsecutiveOnes.py)
* - [717.1比特与2比特字符.py](Array/1BitAnd2BitCharacters.py)
## [字符串(及其相关结构)](String/)
...
* - [重复的子字符串.py](String/RepeatedSubstringPattern.py)
...
* - [669.修剪二叉搜索树.py](BinarySearchTree/TrimABinarySearchTree.py)
* - [653.两数之和IV-输入BST.py](BinarySearchTree/TwoSumIvInputIsABst.py)
...
* - [765.情侣牵手.py](UnionFindSet/CouplesHoldingHands.py)
## [随机(及其相关结构)](Random/)
...
* - [987.二叉树的垂序遍历.py](DeepFirstSearch/VerticalOrderTraversalOfABinaryTree.py)
## [贪心(及其相关结构)](Greedy/)
...
* - [优势洗牌.py](Greedy/AdvantageShuffle.py)
* - [单调递增的数字.py](Greedy/MonotoneIncreasingDigits.py)
* - [重构字符串.py](Greedy/ReorganizeString.py)
* - [1147.段式回文.py](Greedy/LongestChunkedPalindromeDecomposition.py)
* - [871.最低加油次数.py](Greedy/MinimumNumberOfRefuelingStops.py)
* - [630.课程表III.py](Greedy/CourseScheduleIII.py)
* - [1665.完成所有任务的最少初始能量.py](Greedy/MinimumInitialEnergyToFinishTasks.py)
* - [881.救生艇.py](Greedy/BoatsToSavePeople.py)
## [数学(及其相关结构)](Math/)
...
* - [927.三等分.py](Math/ThreeEqualParts.py)
...
* - [2341.数组能形成多少数对.py](HashTable/MaximumNumberOfPairsInArray.py)
* - [2347.最好的扑克手牌.py](HashTable/BestPokerHand.py)
* - [2351.第一个出现两次的字母.py](HashTable/FirstLetterToAppearTwice.py)
* - [2352.相等行列对.py](HashTable/EqualRowAndColumnPairs.py)
...
* - [超级丑数.py](Heap/KthLargestElementInAStream.py)
* - [滑动窗口中位数.py](Heap/SlidingWindowMedian.py)
* - [最小区间.py](Heap/SmallestRangeCoveringElementsFromKLists.py)
* - [786.第K个最小的素数分数.py](Heap/KTHSmallestPrimeFraction.py)
* - [2336.无限集中的最小数字.py](Heap/KTHSmallestPrimeFraction.py)
* - [2336.无限集中的最小数字.py](Heap/KTHSmallestPrimeFraction.py)
## [栈(及其相关结构)](Stack/)
...
* - [743.网络延迟时间.py](Graph/NetworkDelayTime.py)
...
* - [网格中的最短路径.py](BreadthFirstSearch/ShortestPathInAGridWithObstaclesElimination.py)
* - [填充每个节点的下一个右侧节点指针II.py](BreadthFirstSearch/PopulatingNextRightPointersInEachNodeII.py)
* - [连续差相同的数字.py](BreadthFirstSearch/NumbersWithSameConsecutiveDifferences.py)
* - [637.二叉树的层平均值.py](BreadthFirstSearch/AverageOfLevelsInBinaryTree.py)
* - [854.相似度为K的字符串.py](BreadthFirstSearch/KSimilarStrings.py)
...
* - [整数替换.py](BitManipulation/IntegerReplacement.py)
* - [342.4的幂.py](BitManipulation/IntegerReplacement.py)
* - [1356.根据数字二进制下1的数目排序.py](BitManipulation/SortIntegersByTheNumberOf1Bits.py)
* - [405.数字转换为十六进制数.py](BitManipulation/ConvertANumberToHexadecimal.py)
## [排序(及其相关结构)](Sort/)
...
* - [最接近原点的K个点.py](Sort/KClosestPointsToOrigin.py)
* - [通过投票对团队排名.py](Sort/KClosestPointsToOrigin.py)
* - [煎饼排序.py](Sort/PancakeSorting.py)
* - [通过删除字母匹配到字典里最长单词.py](Sort/LongestWordInDictionaryThroughDeleting.py)
* - [三个数的最大乘积.py](Sort/MaximumProductOfThreeNumbers.py)
...
* - [用队列实现栈.py](Design/ImplementStackUsingQueues.py)
* - [设计哈希映射.py](Design/DesignHashmap.py)
* - [设计循环队列.py](Design/DesignCircularQueue.py)
* - [381.O(1)时间插入、删除和获取随机元素-允许重复.py](Design/InsertDeleteGetrandomO1DuplicatesAllowed.py)
## [脑筋急转弯](Brainteaser/)
...
* - [删掉一个元素以后全为1的最长子数组.py](SlidingWindow/LongestSubarrayOf1sAfterDeletingOneElement.py)
* - [找到K个最接近的元素.py](SlidingWindow/FindKClosestElements.py)
* - [最大连续1的个数III.py](SlidingWindow/MaxConsecutiveOnesIII.py)
* - [将x减到0的最小操作数.py](SlidingWindow/MinimumOperationsToReduceXToZero.py)
* - [乘积小于K的子数组.py](SlidingWindow/SubarrayProductLessThanK.py)
* - [1456.定长子串中元音的最大数目.py](SlidingWindow/MaximumNumberOfVowelsInASubstringOfGivenLength.py)
## [前缀和](PrefixSum/)
* - [两个非重叠子数组的最大和.py](PrefixSum/MaximumSumOfTwoNonOverlappingSubarrays.py)
* - [1109.航班预订统计.py](PrefixSum/CorporateFlightBookings.py)
* - [930.和相同的二元子数组.py](PrefixSum/BinarySubarraysWithSum.py)
* - [525.连续数组.py](PrefixSum/ContiguousArray.py)
## [随机化](Randomized/)
* - [打乱数组.py](Randomized/ShuffleAnArray.py)
## [单调栈](MonotonicStack/)
* - [456.132模式.py](MonotonicStack/132Pattern.py)
* - [1019.链表中的下一个更大节点.py](MonotonicStack/NetGreaterNodeInLinkedList.py)
* - [496.下一个更大元素I.py](MonotonicStack/NextGreaterElementI.py)
...
## [枚举](Enumeration/)
* - [949.给定数字能组成的最大时间.py](Enumeration/LargestTimeForGivenDigits.py)
* - [829.连续整数求和.py](Enumeration/ConsecutiveNumbersSum.py)
...
* - [面试题56-I.数组中数字出现的次数.py](CodingInterview/56_01_NumbersAppearOnce.py)
...
* - [面试题 02.05. 链表求和.py](LCCI/SumLists.py)